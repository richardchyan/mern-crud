...
return ( 
      ...
      <div className="mb-8 border-2 border-black rounded-md py-8 overflow-auto">
            ...
            <div className="grid grid-cols-1 mt-4 space-y-6">
                  <Link to={`/edit/${todo._id}`} className="w-1/2 m-auto p-2 text-lg text-white bg-yellow-500 rounded border-2 border-gray-100">Edit Item</Link>
                  <Link to={`/delete/${todo._id}`} className="w-1/2 m-auto p-2 text-lg text-white bg-red-600 rounded border-2 border-gray-100">Delete Item</Link>
